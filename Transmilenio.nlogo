    ...
    if xcor > -3 [
      ...
      ask humans with [ruta = "F14"  or ruta = "L18" ][
        if xcor > -5[
          facexy 9 -13
          ask engines with [ruta-engine = "F14" or ruta-engine = "L18" ] [
            ask humans with [ruta = "F14"] [
              let hxcor xcor
              if any? carriages-on patch hxcor -14 [
                ask carriages with [ xcor = hxcor and ycor = -14 ] [ set load load + 1 ]
                die
              ]
            ]
            ask humans with [ruta = "L18"] [
              let hxcor xcor
              if any? carriages-on patch hxcor -14 [
                ask carriages with [ xcor = hxcor and ycor = -14 ] [ set load load + 1 ]
                die
...
;ruta-engine = "H15" or ruta-engine = "K23" or ruta-engine = "H20"
;*******************************************************************************
...
"" ""
PENS
"Sin estres" 1.0 0 -16777216 true "" "plot count humans with [estres = 0 ]"
"Poco estres" 1.0 0 -8630108 true "" "plot count humans with [estres = 1]"
"Estresado" 1.0 0 -5825686 true "" "plot count humans with [estres = 2]"
"Muy estresdado" 1.0 0 -7500403 true "" "plot count humans with [estres = 3]"
"Super estresado" 1.0 0 -2674135 true "" "plot count humans with [estres = 4]"
...
161
354
N Personas en puerta 1
count humans-on patch 1 1
17
1
11
...
162
403
N Personas en Puerta 2
count humans-on patch 9 1
17
1
11
...
163
452
N Personas en Puerta 3
count humans-on patch 1 -13
17
1
11
...
164
501
N Personas en Puerta 4
count humans-on patch 9 -13
17
1
11
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count humans-on patch 1 1"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count humans-on patch 9 1"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count humans-on patch 1 -13"
